...
static const char *init_commands[] = {"AT+RESTORE",
                                      "AT",
                                      "ATE0",
                                      "AT+CWMODE=1",
                                      "AT+CWQAP",
...
ConnectionState onUartRxStarted(const CommunicationEventData *)
{
    ...
    ATRequestData request_data = {.buffer = init_commands[current_command_id],
                                  .request_id = current_command_id};
...
static const ConnectionStateTransitionFunctionPtr
    comm_state_transition_table[CONNECTION_STATE_COUNT][EVENT_COUNT] = {
        [CONNECTION_STATE_OFF] =
            {
