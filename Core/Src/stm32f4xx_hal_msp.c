...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(ENC1_SCL_GPIO_Port, ENC1_SCL_Pin);

    HAL_GPIO_DeInit(ENC1_SDA_GPIO_Port, ENC1_SDA_Pin);
  ...
  else if(hi2c->Instance==I2C2)
  {
    ...
    PC12     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(ENC2_SCL_GPIO_Port, ENC2_SCL_Pin);

    HAL_GPIO_DeInit(ENC2_SDA_GPIO_Port, ENC2_SDA_Pin);
