...
{
    *out_left_duty =
        calculatePIDResponse(&pid_left, left_wheel_status->filtered_speed, speed_set_point->left);
    *out_right_duty = calculatePIDResponse(
        &pid_right, right_wheel_status->filtered_speed, speed_set_point->right);
}
