...
RobottoErrorCode readAngleAndUpdateWheelsStatus(WheelStatus *left_wheel_status,
                                                WheelStatus *right_wheel_status)
{
...
ActivityStatus runWheelsControlStatusInit(WheelStatus *left_wheel_status,
                                          WheelStatus *right_wheel_status)
{
...
ActivityStatus runWheelsControlStatusRunning(WheelStatus *left_wheel_status,
                                             WheelStatus *right_wheel_status)
{
    ...
    else
    {
        ...
        calculateRequiredDutyCycle(
            &speed_set_point, left_wheel_status, right_wheel_status, &left_duty, &right_duty);
    ...
    // (int)(1000*left_wheel_status->filtered_speed),
    // (int)(1000*right_wheel_status->filtered_speed));
